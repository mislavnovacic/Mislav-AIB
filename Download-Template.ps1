...
$Win10Url = "https://raw.githubusercontent.com/mislavnovacic/Mislav-AIB/main/Template/Win10MultiTemplate.json"
...
-api-version "2021-10-01" -imageTemplateName $imageTemplateName -svclocation $location
